...
run ./configure --prefix="$retroArchInstallDir"  --disable-xmb --enable-udev --disable-ffmpeg --enable-networking --disable-pulse --disable-x11 --enable-sdl --enable-neon --enable-floathard
