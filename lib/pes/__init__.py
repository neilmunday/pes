...
gamepadImageFile = '%s%sgamepad.png' % (resourceDir, os.sep)
networkImageFile = '%s%snetwork.png' % (resourceDir, os.sep)
confDir = '%s%sconf.d' % (baseDir, os.sep)
userDir = '%s%spes' % (os.path.expanduser('~'), os.sep)
userLogDir = '%s%slog' % (userDir, os.sep)
userConfDir = '%s%sconf.d' % (userDir, os.sep)
userRetroArchConfDir = '%s%sretroarch' % (userConfDir, os.sep)
userMupen64PlusConfDir = '%s%smupen64plus' % (userConfDir, os.sep)
...
scriptFile = '%s%scommands.sh' % (userDir, os.sep)