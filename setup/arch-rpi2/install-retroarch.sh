...
run ./configure --prefix="$retroArchInstallDir" --disable-udev --disable-ffmpeg --disable-netplay --disable-pulse --disable-x11 --disable-sdl --enable-neon --enable-floathard
